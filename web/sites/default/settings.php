 ...
 * @endcode
 */
$settings['hash_salt'] = 'zzlLnyo7f2v0ni2tvcsydBrWpmG-2nIULS2SteLiL7AOAUp6nGa1GGuf9dIWKMHEq4viYgG3Wg';
...
$databases['default']['default'] = [
   'database' => 'aleksey',
   'username' => 'aleksey_drupal',
   'password' => 'db_aleksey1992!',
   'host' => 'localhost',
   'port' => '3306',
   'driver' => 'mysql',
   'prefix' => '',
...
$settings['config_sync_directory'] = 'sites/default/files/config_Eo5QjjX2PSq2JLDqYSb6hZ_-c1afBqs5DliJ5X5YCY__wHsIEu3frrkNRZT0F8yZrmVGpoZdKg/sync';
$settings['trusted_host_patterns'] = [
  '^www\.aleksey\.backend-education\.hulk\.nixdev\.co$',
  '^aleksey\.backend-education\.hulk\.nixdev\.co$',
  '^.+\.aleksey\.backend-education\.hulk\.nixdev\.co$',
];
